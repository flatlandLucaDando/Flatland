...
parser.add_argument("--update_every", help="how often to update the network", default=200,
                    type=int)
parser.add_argument("--use_gpu", help="use GPU if available", default=True, type=bool)
parser.add_argument("--num_threads", help="number of threads PyTorch can use", default=4,
                    type=int)
