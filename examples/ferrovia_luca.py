...
railway_example = [[(0,0)] * 25,
				   ...
				   [(7, 270)] + [(1,90)] * 3 + [(1,90)] + [(0,0)] + [(1,0)]*2 +[(0,0)] *2 + [(8,0)] +  [(1,90)] * 3+ [(8,90)]+ [(0,0)] *3 + [(1,0)] +[(0,0)]+  [(1,0)] +[(0,0)]+ [(8,0)]+   [(1,90)] + [(7, 90)] ,
				   [(7, 270)] + [(1,90)] * 3 + [(1,90)] + [(1,90)] + [(1,90)] + [(1,90)] + [(10,90)] + [(2,270)]+ [(2,90)]  +[(1,90)] * 3+ [(10,270)] + [(10,90)]  + [(2,270)] + [(1,90)] + [(5,180)] + [(1,90)] + [(5,270)] + [(1,90)]+  [(5,180)] +[(1,90)]  + [(7, 90)] ,
				   [(7, 270)] + [(1,90)] * 3 + [(1,90)] + [(1,90)] +[(1,90)] +[(1,90)] + [(10,270)] + [(2,90)] + [(1,90)] *5+ [(10,270)] + [(2,90)]+ [(1,90)] + [(10,270)]+ [(1,90)] + [(10,270)]  +[(1,90)] + [(10,270)] +[(1,90)] + [(7, 90)],
				   [(0,0)] * 25,
				   [(0,0)] * 25]
