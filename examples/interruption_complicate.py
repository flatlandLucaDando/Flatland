...
railway_example = [[(0,0)] * 40,
                   [(0,0)] * 24 + [(8,0)] + [(1,90)] * 11 + [(8,90)] + [(0,0)] * 3,
                   [(0,0)] * 24 + [(1,0)] + [(0,0)] * 11 + [(1,0)] + [(0,0)] * 3,
                   [(0,0)] * 24 + [(1,0)] + [(0,0)] * 11 + [(1,0)] + [(0,0)] * 3,
				   [(0,0)] * 8 + [(8,0)] + [(1,90)]*13 + [(12, 0)] + [(1,90)] + [(8,180)] + [(0,0)] * 11 + [(1,0)] + [(0,0)] * 3,
                   [(0,0)] * 8 + [(1, 0)] + [(0, 0)]*13 + [(1,0)] + [(0,0)] * 13 + [(1,0)] + [(0,0)] * 3,
                   [(0,0)] * 8 + [(1, 0)] + [(0, 0)]*13 + [(1,0)] + [(0,0)] * 13 + [(1,0)] + [(0,0)] * 3,
                   [(0,0)] * 8 + [(1, 0)] + [(0, 0)]*13 + [(1,0)] + [(0,0)] * 13 + [(1,0)] + [(0,0)] * 3,
                   [(0,0)] * 8 + [(1, 0)] + [(0, 0)]*13 + [(1,0)] + [(0,0)] * 13 + [(1,0)] + [(0,0)] * 3,
				   [(0,0)] * 8 + [(1, 0)] + [(0, 0)]*13 + [(1,0)] + [(0,0)] * 13 + [(1,0)] + [(0,0)] * 3,
				   [(0,0)] * 8 + [(1, 0)] + [(0, 0)]*13 + [(1,0)] + [(0,0)] * 13 + [(1,0)] + [(0,0)] * 3,
				   [(0,0)] * 8 + [(1, 0)] + [(0, 0)]*13 + [(1,0)] + [(0,0)] * 13 + [(1,0)] + [(0,0)] * 3,
				   [(0,0)] + [(7, 270)] + [(1,90)] * 5 + [(1,90)] + [(12, 180)] + [(1,90)]*13 + [(12, 180)] + [(1,90)] * 13 +  [(8,180)] + [(0,0)] * 3,
                   [(0,0)] * 40]
